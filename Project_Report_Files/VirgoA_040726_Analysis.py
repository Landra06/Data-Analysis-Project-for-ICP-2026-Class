...
data = np.loadtxt("VirgoA_040726_fixed.txt", skiprows=2)
...
plt.title("Analysis of Virgo A Trial from April 7 2026")
plt.legend()
plt.tight_layout()
plt.savefig("VirgoA_Boxcar.png", dpi=300, bbox_inches="tight")
