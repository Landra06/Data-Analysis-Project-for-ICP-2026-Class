...
Then, I did boxcar smoothing on the averaged values, which
replaces each data point with the average of nearby values.

\begin{equation}
Y_k = \frac{1}{2r + 1} \sum_{m=-r} y_k+m
\label{Boxcar Equation}
\end{equation}
...
This was done with the signal to noise ratio, which is calculated by:
\begin{equation}
\mathrm{SNR} = \frac{S_{\mathrm{peak}} - \mu_{\mathrm{noise}}}{\sigma_{\mathrm{noise}}}
\label{Signal to Noise Ratio Equation}
\end{equation}
